...
public class SistemaPessoa {
    ...
    public void iniciarSistema() {
        ...
        itemMenuCadastroUsuarios.addActionListener(e -> {
            CadastroInterface cadastroUsuarios = new CadastroUsuarios(principal); 
            cadastroUsuarios.exibir();
        });

        itemMenuCadastroPessoas.addActionListener(e -> {
            CadastroInterface cadastroPessoas = new CadastroPessoasFisica(principal); 
            cadastroPessoas.exibir();
        });

        itemMenuVisualizacaoListaUsuarios.addActionListener(e -> {
            ListaInterface listaUsuarios = new ListaUsuarios(principal); 
            listaUsuarios.exibir();
        });

        itemMenuVisualizacaoListaPessoas.addActionListener(e -> {
            ListaInterface listaPessoas = new ListaPessoas(principal); // Usa a interface ListaInterface
            listaPessoas.exibir(); // Chama o método exibir() da ListaPessoas
        });
